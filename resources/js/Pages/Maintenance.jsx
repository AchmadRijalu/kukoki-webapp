    ...
    return (
        <MainLayout>
            <section className="bg-white">
                <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-24 lg:px-12">
                    <svg className="mx-auto mb-4 w-10 h-10 text-darkblue" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512 512">
