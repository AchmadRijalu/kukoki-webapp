        ...
        <div className="bg-white w-full min-h-screen flex flex-col justify-between">
            ...
            <div className="lg:mx-64 md:mx-8 sm:mx-8 h-max mt-8 mb-12 md:p-0 mini:p-3">
                <div className="flex flex-col justify-center items-center mb-8">
                    ...
                    <div className="flex flex-row">
                        <h3 className="text-green md:text-1xl sm:text-1xl mini:text-1xl text-l font-bold text-center">
                    ...
                    <div className="flex flex-row mt-8 lg:w-5/6 bg-white rounded-md p-6 border-none drop-shadow-md justify-between">
                        <div className="flex flex-row items-center">
                            ...
                            <p className="text-2xl ml-8 text-darkgreen font-bold">Pesto Pasta Chicken</p>
                        </div>
                        <div className="flex flex-row items-center">
                            <p className="text-2xl ml-8 text-green font-bold">V</p>
                        </div>
                    </div>
                    <div className="flex flex-col mt-8 sm:w-full md:w-full lg:w-5/6 bg-white rounded-md p-4 border-none drop-shadow-md justify-between">
                        <div className="flex flex-row mt-2 justify-between items-center lg:mx-2">
                            <div className="flex w-5/6">
                                <p className="text-xl text-darkgreen font-bold">Nilai Makanan</p>
                            </div>
                        ...
                        <button class="bg-green font-semibold text-white py-3 px-4 rounded-md mt-4 mx-2">
                            Bagikan Ulasan
                        </button>
                    </div>
                </div>
