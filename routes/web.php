...
Route::get('/auth/google', [RegisterController::class, 'redirectToProvider'])->middleware('guest');
Route::get('/auth/google/callback', [RegisterController::class, 'handleProviderCallback'])->middleware('guest');
...
// Review Route
Route::get('/ulasan/{menu_id}', [ReviewController::class, 'create'])->middleware('auth')->name('ulasan.create');
Route::post('/ulasan/{menu_id}', [ReviewController::class, 'store'])->middleware('auth')->name('ulasan.store');
